        ...
        <main class="container-fluid" id="portfolio-container">
            ...
            <section class="row">
                ...
                <div class="col-md-4 col-xs apps" id="projects">
                    <a href="https://roccolosito.github.io/meditationApp/" target="_blank" rel="noopener noreferrer"><img class="app-graphic"
                    ...
                    <div class="row bottom-app">
                        <div class="col col-xs">
                            <a href="https://chomptheburger.herokuapp.com/" target="_blank" rel="noopener noreferrer"><img class="app-graphic"
                    ...
                    <div class="row bottom-app">
                        <div class="col col-xs">
                            <a href="https://roccolosito.github.io/weatherDashboard/" target="_blank" rel="noopener noreferrer"><img class="app-graphic"
                ...
                <div class="col-md-4 col-xs apps" id="projects2">
                    <a href="https://stellavybezz.herokuapp.com/" target="_blank" rel="noopener noreferrer"><img class="app-graphic" src={stella}
                    ...
                    <div class="row bottom-app">
                        <div class="col col-xs">
                            <a href="https://quick-note-taker.herokuapp.com/" target="_blank" rel="noopener noreferrer"><img class="app-graphic"
                    ...
                    <div class="row bottom-app">
                        <div class="col col-xs">
                            <a href="https://roccolosito.github.io/NYT-Article-Search/" target="_blank" rel="noopener noreferrer"><img class="app-graphic"
